              ...
              {images.map((_, index) => (
                <button
                  ...
                  className={`rounded-full transition-all duration-300 cursor-pointer ${
                    index === current ? "bg-primary w-3 h-3" : "bg-border w-2 h-2 hover:bg-primary/60"
                  }`}
          ...
          <Card className="border-primary/30 bg-card/70 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-shadow duration-300">
            <CardContent className="p-8">
              <div className="mb-6">
                ...
                <p className="text-lg text-primary font-semibold mb-6">{founder.role}</p>
              </div>

              <div className="border-t border-border pt-6 mb-6">
                <p className="text-base text-muted-foreground leading-relaxed">{founder.bio}</p>
              </div>
